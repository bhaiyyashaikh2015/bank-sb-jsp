...
<body>
	<div class="container">
		<h1 class="d-flex justify-content-center">Deposit money in the bank</h1>
		<hr>
		<br> <a class="btn btn-primary"
			href="<%=request.getContextPath()%>/">Home</a> <br>    <br>

		<form:form action="deposit" modelAttribute="account" method="GET">
			...
			<div class="form-group">
				<form:label path="balance">Enter amount to deposit</form:label> 
